//
// DocKitPage.xaml.cpp
// Implementation of the DocKitPage class
//
...
using namespace WindowsApp::Common;
...
DocKitPage::DocKitPage()
{
	...
	navigationHelper->LoadState += ref new Common::LoadStateEventHandler(this, &DocKitPage::LoadState);
	navigationHelper->SaveState += ref new Common::SaveStateEventHandler(this, &DocKitPage::SaveState);

	itemListView->SelectionChanged += ref new SelectionChangedEventHandler(this, &DocKitPage::ItemListView_SelectionChanged);
	Window::Current->SizeChanged += ref new WindowSizeChangedEventHandler (this, &DocKitPage::Window_SizeChanged);
	InvalidateVisualState();

}

DependencyProperty^ DocKitPage::_defaultViewModelProperty =
	DependencyProperty::Register("DefaultViewModel",
		TypeName(IObservableMap<String^,Object^>::typeid), TypeName(DocKitPage::typeid), nullptr);

/// <summary>
/// used as a trivial view model.
/// </summary>
IObservableMap<String^, Object^>^ DocKitPage::DefaultViewModel::get()
{
	return safe_cast<IObservableMap<String^, Object^>^>(GetValue(_defaultViewModelProperty));
}

DependencyProperty^ DocKitPage::_navigationHelperProperty =
	DependencyProperty::Register("NavigationHelper",
		TypeName(Common::NavigationHelper::typeid), TypeName(DocKitPage::typeid), nullptr);

/// <summary>
/// Gets an implementation of <see cref="NavigationHelper"/> designed to be
/// used as a trivial view model.
/// </summary>
Common::NavigationHelper^ DocKitPage::NavigationHelper::get()
{
...
void DocKitPage::LoadState(Platform::Object^ sender, Common::LoadStateEventArgs^ e)
{
...
void DocKitPage::SaveState(Platform::Object^ sender, Common::SaveStateEventArgs^ e)
{
...
void DocKitPage::Window_SizeChanged(Platform::Object^ sender, Windows::UI::Core::WindowSizeChangedEventArgs^ e)
{
	InvalidateVisualState();
}
...
void DocKitPage::ItemListView_SelectionChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e)
{
...
Platform::String^ DocKitPage::DetermineVisualState()
{
	if (!UsingLogicalPageNavigation())
		return "PrimaryView";
...
void DocKitPage::OnNavigatedTo(NavigationEventArgs^ e)
{
	NavigationHelper->OnNavigatedTo(e);
}

void DocKitPage::OnNavigatedFrom(NavigationEventArgs^ e)
{
